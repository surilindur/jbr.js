...
jest.mock<typeof import('componentsjs')>('componentsjs', () => <typeof import('componentsjs')> <unknown> ({
...
jest.mock<typeof import('fs-extra')>('fs-extra', () => <typeof import('fs-extra')> ({
...
describe('ExperimentLoader', () => {
  ...
  describe('instantiateExperiments', () => {
    ...
    it('instantiates a combinations-based config', async() => {
      ...
      expect(componentsManager.configRegistry.register)
        .toHaveBeenNthCalledWith(1, 'path/to/experiment/jbr-combinations.json');
      expect(componentsManager.configRegistry.register)
        .toHaveBeenNthCalledWith(2, Path
          .join('path/to/experiment', 'combinations', 'combination_0', 'jbr-experiment.json'));
      expect(componentsManager.configRegistry.register)
        .toHaveBeenNthCalledWith(3, Path
          .join('path/to/experiment', 'combinations', 'combination_1', 'jbr-experiment.json'));
      expect(componentsManager.instantiate)
        .toHaveBeenCalledWith('urn:jbr:experiment:combination_0');
      expect(componentsManager.instantiate)
        .toHaveBeenCalledWith('urn:jbr:experiment:combination_1');
    });
